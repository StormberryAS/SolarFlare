...
(function () {
  ...
  dialog.innerHTML = [
    ...
    '<h2 class="sb-gate-title" id="' + TITLE_ID + '">Before you use SolarFlare</h2>',
    ...
    '<p><strong>The readings here are simulated.</strong> They are produced by a seeded algorithm, not observed by any instrument, and they bear no relation to actual solar or geomagnetic activity.</p>',
    '<p>For real space weather, use <a href="https://www.swpc.noaa.gov/" target="_blank" rel="noopener noreferrer">NOAA SWPC</a>.</p>',
    '</div>',
    '</div>',
